...
<a style="width: auto; position: absolute; right: -2rem; padding: 0; transform: translateX(); "
  ...
  <div class="col-12 md:col-10 xl:col-9 mr-auto ml-auto  grid p-0" v-else style="gap: ; margin-top: 4rem; position: relative;display: flex;"> 

   
    <img v-if="screenWidth>767" class="  " style="right: 96%;top: 1rem; position:absolute;height: 78%; object-fit: contain" :src="'/images/fire_left.png'" alt="">
    <img v-if="screenWidth>767" class="  " style=" left:96%;top: 1rem; position:absolute;height: 78%; object-fit: contain" :src="'/images/fire_right.png'" alt="">
  
    <div class=" col-12 m-auto">
      <Carousel  circular   class= ""   :responsiveOptions="responsiveOptions"  style="; border-bottom:  2rem solid  black;background-color:var(--primary-color)  ;overflow: hidden; border-radius: 2rem ; height:max-content; padding-top:;margin: 0;z-index: 9999999;" :value="category.products" :numVisible="category.products[3]? 4: 3" :numScroll="1"  >
        <template #item="slotProps" >
   
            <div class=" m-3  ">
                 <TarjetaMenu  style="   ;width: 100%;"    :product="slotProps.data"></TarjetaMenu>
    ...
    <p class="  m-auto text-center text-2xl" style="border-radius: 0 0 10rem 10rem ; left: 50%;top: 0; width: 20rem; color: white; background-color: black; position: ; font-weight: bold; height:min-content  ">
 
 {{ category.category.name.toUpperCase() }}</p>
    </div>
