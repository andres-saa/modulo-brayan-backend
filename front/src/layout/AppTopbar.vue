...
// import { products } from '../service/menuOptions';
...
<template>
    <div class="layout-topbar lg:pl-8 lg:pr-8 md:pr-8 " style=" z-index: ">
        ...
        <div  class="col-12 " style=" display:  flex; height: 100%; width: 100%; justify-content: center; align-items: start; gap: 2rem;">
            <router-link to="/">
            <Button @click="showProductDialog = !showProductDialog"
                style="color: black;border: none; background-color: rgb(240, 240, 240); border-radius: 0.5rem; font-weight: bold;margin-bottom: 2rem;">PRODUCTOS</Button>
        </router-link>

        <router-link to="/categories">
            <Button @click="showProductDialog = !showProductDialog"
                style="color: black;border: none; background-color: rgb(240, 240, 240); border-radius: 0.5rem; font-weight: bold;margin-bottom: 2rem;">CATEGORIAS</Button>
        </router-link>

        <router-link to="/providers">
            <Button @click="showProductDialog = !showProductDialog"
                style="color: black;border: none; background-color: rgb(240, 240, 240); border-radius: 0.5rem; font-weight: bold;margin-bottom: 2rem;">PROVEEDORES</Button>
        </router-link>
