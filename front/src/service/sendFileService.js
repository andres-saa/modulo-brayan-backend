import { URI } from "./conection";
 ...
 function uploadPDF(pdfFile,type_document,site_name) {
  ...
  function uploadProductImage(image,product_id) {
    // URL del servidor donde deseas enviar el PDF
    const serverURL = `${URI}/upload-product-image/${product_id}`;
...
//   });
  ...
  export {uploadPDF,uploadUserPhotoProfile,uploadProductImage}
